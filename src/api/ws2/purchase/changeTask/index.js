...
const VUE_APP_BMCHANGESUMMARY = axios(process.env.VUE_APP_TOOLING + '/bmChangeSummary')
const VUE_APP_BMCHANGESUMMARYFile = axiosFile(process.env.VUE_APP_TOOLING + '/bmChangeSummary')
//BM新增单变更车型下拉列表
