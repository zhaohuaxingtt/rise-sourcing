...
export function getSimulateRecord(params) {
  return requst({
      url: `/nego-assistant/nomi-allocation-simulate-record/${params.rfqId}`,
      method: "GET"
  })
}
...
export function refreshSimulateRecord(params) {
  return requst({
      url: `/nego-assistant/nomi-allocation-simulate-record-refresh/${params.rfqId}`,
      method: "GET"
  })
}
...
export function saveSimulateRecord(data) {
  return requst({
      url: `/nego-assistant/nomi-allocation-simulate-record-save`,
      method: "POST",
      data
  })
}