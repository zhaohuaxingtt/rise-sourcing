  ...
  scoremanageNavListLeft: [
    {
      ...
      name: 'SQE评分',
      message: 0,
      url: '/targetpriceandscore/supplierscore/sqe',
      activePath: 'sqe',
      key: 'SQE评分',
      permissionKey: 'CSCSCOREMANAGE_MENU_SUPPLIERSCORE',
      // permissionKey: 'CSCSCOREMANAGE_MENU_SQESCORE',
      // permissionName: 'SQE评分',
      group: 2,
    },
  ],
  scoremanageThirdMenu: [
    {
      ...
      name: '待评分',
      message: 0,
      url: '/targetpriceandscore/supplierscore/sqe/tobegraded',
      activePath: 'tobegraded',
      key: '待评分',
      permissionKey: 'CSCSCOREMANAGE_MENU_SUPPLIERSCORE',
      // permissionKey: 'CSCSCOREMANAGE_MENU_SQESCORE_TOBEGRADED',
      // permissionName: '待评分',
      group: 2,
    },{
      value: 2,
      name: '待审核',
      message: 0,
      url: '/targetpriceandscore/supplierscore/sqe/audit',
      activePath: 'audit',
      key: '待审核',
      permissionKey: 'CSCSCOREMANAGE_MENU_SUPPLIERSCORE',
      // permissionKey: 'CSCSCOREMANAGE_MENU_SQESCORE_AUDIT',
      // permissionName: '待审核',
      group: 2,
    },{
      value: 3,
