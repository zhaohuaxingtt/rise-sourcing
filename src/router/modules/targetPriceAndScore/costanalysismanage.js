 ...
 * @LastEditTime: 2021-12-08 09:59:10
...
export default [
  {
    ...
    meta: { title: "成本分析管理", activeMenu: ['RISE_WORKBENCH', '/TARGETPRICEANDSCORE'] },
    ...
    children: [
      {
        ...
        meta: { title: "成本分析管理-成本分析", activeMenu: ['RISE_WORKBENCH', '/TARGETPRICEANDSCORE'] },
        component: () => import("@/views/costanalysismanage/components/home"),
      },
      {
        path: "rfqdetail",
        name: "costAnalysisManageRfqDetail",
        meta: { title: "成本分析管理-RFQ详情", activeMenu: ['RISE_WORKBENCH', '/TARGETPRICEANDSCORE'] },
    ...
    children: [
      {
        ...
        meta: { title: "数据维护-人工成本维护", activeMenu: ['RISE_WORKBENCH', '/TARGETPRICEANDSCORE'] },
      ...
      },
      {
        ...
        meta: { title: "数据维护-人工成本数据维护", activeMenu: ['RISE_WORKBENCH', '/TARGETPRICEANDSCORE'] },
