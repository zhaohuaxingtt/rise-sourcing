 ...
 * @LastEditTime: 2021-08-07 10:26:15
...
export const staticRouter = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/partsign/version/volume'),
      },
      {
        ...
        component: () => import('@/views/partsign/version/enquiry'),
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/views/partsrfq/editordetailInfo'),
      },
      {
        ...
        component: () => import('@/views/partsrfq/assistant'),
      },
      {
        ...
        component: () =>
          import(
            '@/views/partsrfq/editordetail/components/rfqPending/components/supplierScore/components/partScoring'
          ),
      },
      {
        path: '/report',
      ...
      },
      {
        ...
        name: 'importFiles',
        component: () => import('@/views/designateFiles/importFiles'),
      },
      {
        path: '/sourcing/importfiles/detaillist',
        name: 'filesDetailList',
        component: () => import('@/views/designateFiles/importFiles/detail'),
      },
      {
      ...
      // 配件相关路由
      {
        ...
        meta: { title: '配件需求签收' },
        component: () =>
          import('@/views/accessoryPart/signForPartsDemand/index'),
      },
      {
      ...
      },
      {
        ...
        meta: { title: '配件详情' },
        component: () =>
          import('@/views/accessoryPart/accessoryPartDetail/index'),
      },
      // 报价详情相关路由
      {
        path: '/supplier/quotationdetail',
        name: 'quotationDetail',
        component: () => import('@/views/supplier/quotationdetail'),
      },
      {
