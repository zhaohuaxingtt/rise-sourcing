 ...
 * @LastEditTime: 2021-09-03 16:50:47
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \front-web\src\components\partsprocure\createNomiappBtnAsse\data.js
 */
export const tableTitle = [
  {props:'supplierName',name:'',key: 'LK_FSNRGSNRNUMBER',tooltip:false,width:''},
  {props:'fsnrGsnrNum',name:'FS号',key: 'LK_FSNRGSNRNUMBER',tooltip:false,width:''},
