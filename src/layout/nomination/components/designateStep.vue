    ...
    <div class="designateStep">
        ...
        <div class="pageTitle flex-between-center-center">
            ...
            <div class="btnList flex-align-center">
                ...
                <iLoger :config="{module_obj_ae: '定点申请', bizId_obj_ae: 'desinateId', queryParams:['bizId_obj_ae']}" credentials isPage isUser class="margin-left20" optionDicKey="LOG_OPERATION_TYPES" optionDicKey2="定点申请详情页" />
