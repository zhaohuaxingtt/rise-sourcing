    ...
    <iSearch class="margin-top20" @sure="sure" @reset="reset">
      <el-form>
        <el-form-item
          ...
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_FSGSSPNO | FSGSSPNO
          "
        >
          <iInput
            clearable
        ...
        <el-form-item
          ...
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_PARTNUM | 零件号
          "
        >
          <!-- <iInput
            clearable
        ...
        <el-form-item
          :label="language('nominationLanguage_LingJianMingCheng', '零件名称')"
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_PARTNAME | 零件名称
          "
        >
          <iInput
            clearable
        ...
        <el-form-item
          ...
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_CARTYPE | 车型
          "
        >
          <iSelect
            clearable
            :placeholder="
              language('LK_QINGXUANZE', '请选择') + language('CHEXING', '车型')
            "
        ...
        <el-form-item
          ...
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_CARTYPEPROJ | 车型项目
          "
        >
          <iSelect
            clearable
            ...
            "
            v-model="formRecord.carTypeProjectId"
          >
            <el-option
              value=""
              :label="language('all', '全部') | capitalizeFilter"
        ...
        <el-form-item
          :label="language('JIAGEZHUANGTAI', '价格状态')"
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_APPLICATIONSTATUS | 价格状态
          "
        >
          <iSelect
            clearable
        ...
        <el-form-item
          :label="language('LINGJIANXIANGMULEIXING', '零件项目类型')"
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_PARTPROJTYPE | 零件项目类型
          "
        >
          <iSelect
            clearable
        ...
        <el-form-item
          ...
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_CSF | 询价采购员
          "
        >
          <iInput
            clearable
        ...
        <el-form-item
          :label="language('LINIE', 'LINIE')"
          v-permission.auto="SOURCING_NOMINATION_NOMINATIONRECORD_LINIE | LINIE"
        >
          <iInput
            clearable
        ...
        <el-form-item
          :label="language('DINGDIANSHENQINGLEIXING', '定点申请类型')"
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_NOMINATIONTYPE | 定点申请类型
          "
        >
          <iSelect
            clearable
        ...
        <el-form-item
          :label="language('DINGDIANSHIJIAN', '定点时间')"
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_NOMIDATE | 定点时间
          "
        >
          <iDatePicker
            clearable
        ...
        <el-form-item
          ...
          v-permission.auto="
            SOURCING_NOMINATION_NOMINATIONRECORD_SHOWSELF | 显示自己
          "
        >
          <iSelect
...
export default {
  ...
  methods: {
    sure() {
      let form = {
        ...this.formRecord,
        nominateStartTime: Array.isArray(this.formRecord.nominateTime)
          ? this.formRecord.nominateTime[0]
          : undefined,
        nominateEndTime: Array.isArray(this.formRecord.nominateTime)
          ? this.formRecord.nominateTime[1]
          : undefined,
      };
    ...
    getSelectGroup() {
      let types = ["RFQ_PART_STATUS_CODE_TYPE", "PPT", "PRICE_STATE"];
