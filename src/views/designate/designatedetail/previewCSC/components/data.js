...
export const decisionType = [
    ...
    {key:'Part List',name:'Part List',path:'/designate/decisiondata/partlist'},
    ...
    {key:'Single Sourcing',name:'Single Sourcing',path:'/designate/decisiondata/singlesourcing'},
    {key:'A-B Price',name:'A-B Price',path:'/designate/decisiondata/abprice'},
    {key:'Cost Analysis',name:'Cost Analysis',path:'/designate/decisiondata/costanalysis'},
    ...
    {key:'Awarding Scenario',name:'Awarding Scenario',path:'/designate/decisiondata/awardingscenario'},
