<template>
  <div class="layout">
    <el-table :data="res">
      <el-table-column prop="name" label="TABLE">
        <template slot-scope="scope">
          ...
          <div v-for="(item,key) in scope.row.ext" :key="item.id">
            <el-table
              max-height="120px"
              :data="item"
              border
              :class="item !== scope.row.ext.pay ? 'tab-thead-style' : ''"
              style="box-sizing: border-box; border-top: none"
              :span-method="objectSpanMethod"
            >
              <el-table-column
                :label="item === scope.row.ext.pay ? '运送到' : ''"
                prop="area"
              ></el-table-column>
              <el-table-column
                :label="item === scope.row.ext.pay ? '首重' : ''"
                prop="weight"
              ></el-table-column>
              <el-table-column
                :label="item === scope.row.ext.pay ? '运费' : ''"
                prop="first_price"
              ></el-table-column>
              <el-table-column
                :label="item === scope.row.ext.pay ? '续重' : ''"
                prop="weight_incre"
              ></el-table-column>
              <el-table-column
                :label="item === scope.row.ext.pay ? '最终运费' : ''"
                prop="extend_price"
              ></el-table-column>
              <el-table-column
                :label="item === scope.row.ext.pay ? '最终运费' : ''"
