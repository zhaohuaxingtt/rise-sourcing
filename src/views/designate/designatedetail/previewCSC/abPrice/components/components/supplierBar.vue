 ...
 * @LastEditTime: 2023-02-03 16:04:32
...
<template>
  <div>
    <div class="page-header margin-bottom20">
      <span>Unit:RMB</span>
      <span>Supplier Offer Comparison ( Passat NF )</span>
      <div class="flex">
        <div class="legend">
        ...
        <el-table-column :key="item.supplier" align="center" minWidth="140px">
          <template slot-scope="scope">
            <template v-if="scope.row.label == 'A-B Price Comparison'">
              <barItem :key="item.supplier" :barName="item.supplier" />
            </template>
            <template
