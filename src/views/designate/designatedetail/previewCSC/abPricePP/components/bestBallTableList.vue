    ...
    >
      ...
      <el-table-column align="center">
        ...
        <el-table-column label="Rating" align="center">
          <el-table-column label="E" align="center" prop="erate" min-width="60">
            <template slot-scope="scope">
          ...
          >
          <el-table-column label="Q" align="center" prop="qrate" min-width="60">
            <template slot-scope="scope">
          ...
          >
          <el-table-column label="L" align="center" prop="lrate" min-width="60">
            <template slot-scope="scope">
