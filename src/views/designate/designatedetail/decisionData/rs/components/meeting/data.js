...
export const nomalTableTitle = [
  ...
  {props:'beginYearReduce',name:'年降开始时间', enName: 'Start Time of LTC', key: "", minWidth: 135},
  {props:'investFee',name:'投资费(不含税)', enName: 'Invest',enName1:'(excl. VAT)', key: "", minWidth: 100},
  {props:'devFee',name:'开发费(含税)', enName: 'Develop Cost',enName1:'(incl. VAT)', key: "", minWidth: 120},
...
export const gsTableTitle = [
  ...
  {props:'partName',name:'零件名称', enName: 'Part Name', key: "", minWidth: 90},
  {props:'logNorm',name:'物流标准', enName: 'Log Norm', key: "", minWidth: 88},
  {props:'suppliersNow',name:'现供供应商', enName: 'Current Supplier', key: "", minWidth: 126},
  {props:'supplierSapCode',name:'供应商号', enName: 'Code', key: "", minWidth: 65},
  {props:'supplierName',name:'供应商', enName: 'Supplier', key: "", minWidth: 74},
  {props:'prodLocation',name:'产地', enName: 'Prod.Location', key: "", minWidth: 88},
  {props:'share',name:'份额', enName: 'Share', enName1:'(%)', key: "", minWidth: 58},
  {props:'carLine',name:'车型', enName: 'Carline', key: "", minWidth: 60},
  {props:'presentPrice',name:'现供价格', enName: 'Current Price', key: "", minWidth: 100},
  {props:'status',name:'供货状态', enName: 'Status', key: "", minWidth: 74},
  {props:'aprice',name:'A价', enName: 'A Price', key: "", minWidth: 55 },
  {props:'bprice',name:'B价', enName: 'B Price', key: "", minWidth: 55},
  {props:'ltc',name:'年降', enName: 'LTC', key: "", width: 52 },
  {props:'beginYearReduce',name:'年降开始时间', enName: 'Start Time of LTC', key: "", minWidth: 135},
  {props:'investFee',name:'投资费(不含税)', enName: 'Invest' ,enName1:'(excl. VAT)', key: "", minWidth: 100},
  {props:'devFee',name:'开发费(含税)', enName: 'Develop Cost',enName1:'(incl. VAT)', key: "", minWidth: 120},
  {props:'addFee',name:'认可费', enName: 'Release Cost', key: "", minWidth: 90},
  {props:'savingFee',name:'估算节约值', enName: 'Estimaled Savings', key: "", minWidth: 130},
...
export const dbTableTitle = [
  ...
  {props:'cfTargetBPrice',name:'财务目标B价', enName: 'CF Target B Price', key: "", minWidth: 134},
  {props:'status',name:'状态', enName: 'Status', key: "", minWidth: 55},
  {props:'purchaseClause',name:'采购条款', enName: 'Purchasing Term', key: "", minWidth: 120},
  {props:'payClause',name:'支付条款', enName: 'Payment Term', key: "", minWidth: 110},
  {props:'aprice',name:'A价', enName: 'A Price', key: "", minWidth: 55},
  {props:'bprice',name:'B价', enName: 'B Price', key: "", minWidth: 55},
  {props:'ltc',name:'年降', enName: 'LTC', key: "", width: 52},
  {props:'beginYearReduce',name:'年降开始时间', enName: 'Start Time of LTC', key: "", minWidth: 135},
