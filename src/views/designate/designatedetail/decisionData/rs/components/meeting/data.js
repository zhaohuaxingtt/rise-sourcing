...
export const nomalTableTitle = [
  {props:'fsnrGsnrNum',name:'FS号', enName: 'FS-NO.', key: "",minWidth:54},
  ...
  {props:'rw',name:'欧价', enName: 'RW', key: "",minWidth:80},
  {props:'cfTargetAPrice',name:'财务目标A价', enName: 'CF Target A Price', key: "",minWidth:110},
  {props:'cfTargetBPrice',name:'财务目标B价', enName: 'CF Target B Price', key: "",minWidth:110},
  ...
  {props:'ltc',name:'年降', enName: 'LTC', key: "", minWidth: 48},
  {props:'beginYearReduce',name:'年降开始时间', enName: 'Start Time of LTC', key: "", minWidth: 110},
  {props:'investFee',name:'投资费(不含税)', enName: 'Invest',enName1:'(excl. VAT)', key: "", minWidth: 110},
  {props:'devFee',name:'开发费(含税)', enName: 'Develop Cost',enName1:'(incl. VAT)', key: "", minWidth: 146},
  {props:'tto',name:'采购金额', enName: 'Turnover', key: "", key: "", minWidth: 90},
]

// 配件
export const sparePartTableTitle = [
  {props:'fsnrGsnrNum',name:'SP号', enName: 'SP-NO.', key: "", minWidth: 54},
  ...
  {props:'beginYearReduce',name:'年降开始时间', enName: 'Start Time of LTC', key: "", minWidth: 110},
  {props:'investFee',name:'投资费(不含税)', enName: 'Invest(excl.VAT)', key: "", minWidth: 110},
  {props:'devFee',name:'开发费(含税)', enName: 'Develop Cost',enName1:'(incl. VAT)', key: "", minWidth: 146},
  {props:'tto',name:'采购金额', enName: 'Turnover', key: "", minWidth: 90},
]
