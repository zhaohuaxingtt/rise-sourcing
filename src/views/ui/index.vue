 ...
 * @LastEditTime: 2021-02-25 15:49:35
      ...
      <el-col :span="24">
        <icard title="el-tabel">
          <el-table slot="components" :data="TabelData">
            <el-table-column
              v-for="(items, index) in tabelTile"
              :key="index"
              align="center"
              :label="items.name"
              :prop="items.key"
      ...
      <el-col :span="24">
        <icard title="iButton">
          ...
          <iButton
            ...
            @click="repeatClick"
            icon="el-icon-delete"
            >iButton NoRepeat Submit</iButton
          >
          <iButton slot="components" size="mini">Mini iButton example</iButton>
          <iButton slot="components" size="mini" loading
            >Mini iButton example</iButton
          >
        </icard>
      </el-col>
    </el-row>
...
<script>
import { iInput, iSelect, iButton, iCard, iTabs, icon } from "@/components";
