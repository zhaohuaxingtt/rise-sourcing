...
export const previewBaicFrom = [
    {label:'是否TOP',labelWidth:'155px',labelKey:'LK_AEKO_SHIFOUTOP',props:'isTop',type:'select',permissionKey:'AEKO_DETAIL_TAB_FENGMIAN_TEXT_ISTOP|是否TOP',editPermissionKey:'AEKO_DETAIL_TAB_FENGMIAN_SELECT_ISTOP|是否TOP-编辑',selectOption:'isTop',required:true,editable:true,isObj:true,},
    ...
    {label:'新⾸批送样周期(周数)',labelWidth:'155px',labelKey:'LK_AEKO_XINSHOUPISONGYANGZHOUQI',props:'sendCycle',type:'input',required:true,editable:true,permissionKey:'AEKO_DETAIL_TAB_FENGMIAN_TEXT_SENDCYCLE|新⾸批送样周期',editPermissionKey:'AEKO_DETAIL_TAB_FENGMIAN_INPUT_SENDCYCLE||新⾸批送样周期-编辑',},
