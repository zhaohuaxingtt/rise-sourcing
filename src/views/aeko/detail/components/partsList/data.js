...
export const SearchList = [
  {props:'partNum',label:'零件号',type:'input',labelKey:'LK_LINGJIANHAO',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_INPUT_PARTNUM'},
  {props:'partNameZh',label:'零件名称',type:'input',labelKey:'LK_LINGJIANMINGCHENG',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_INPUT_PARTNAME'},
  {props:'cartypeCode',label:'⻋型项⽬',type:'select',labelKey:'LK_AEKOCHEXINGXIANGMU',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_SELECT_CARTYPECODE',selectOption:'cartypeCode',showCode:'Aeko',multiple:true,filterable:true},
  {props:'linieDeptNumList',label:'科室',type:'select',labelKey:'LK_AEKOKESHI',selectOption:'linieDeptNumList',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_INPUT_LINIEDEP',filterable:true,multiple:true,},
  {props:'buyerName',label:'Linie',type:'select',labelKey:'LK_AEKOLINIE',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_SELECT_BUYERNAME',selectOption:'buyerName',noShowAll:true,filterable:true,clearable:true},
  {props:'brand',label:'品牌',type:'select',labelKey:'LK_AEKOPINGPAI',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_SELECT_BRAND',selectOption:'brand'},
  {props:'cartype',label:'车型',type:'select',labelKey:'LK_AEKO_CHEXING',permission:'AEKO_DETAIL_TAB_LINGJIANQINGDAN_INPUT_CARTYPE',selectOption:'cartype',multiple:true,showCode:'AeA',filterable:true},
]
