...
export const tableCsfTitle = [
  { props: "isTop", name: "", key: "", tooltip: false, width:30 },
  { props: "aekoNum", name: "AEKO号", key: "LK_AEKOHAO", tooltip: true,width:85 },
  { props: "auditTypeName", name: "审批类型", key: "SHENPILEIXING", tooltip: true, width:115  },
  { props: "describe", name: "描述", key: "LK_AEKOMIAOSHU", tooltip: true ,width:60},
  ...
  { props: "supplier", name: "主要供应商", key: "LK_AEKO_ZHUYAOGONGYINGSHANG", tooltip: true,width:80  },
  { props: "EP1", name: "增加材料成本（RMB/车）", key: "LK_AEKO_ZENGJIACAILIAOCHENGBEN", tooltip: true,width:136},
  { props: "EP2", name: "增加投资费用", key: "LK_AEKO_ZENGJIATOUZIFEIYONG", tooltip: true,width:85 },
  { props: "EP3", name: "其他费用", key: "LK_AEKO_QITAFEIYONG", tooltip: true,width:60 },
  { props: "DepartmentName", name: "科室", key: "LK_KESHI", tooltip: true,width:60 },
  { props: "buyerName", name: "采购员", key: "CAIGOUYUAN", tooltip: true },
  { props: "attach", name: "审批附件", key: "LK_AEKO_SHENPIFUJIAN", tooltip: true,width:60 },
  { props: "date", name: "AEKO截止日期", key: "LK_AEKO_AEKOJIEZHIRIQI" ,tooltip: true ,width:100},
  { props: "createDate", name: "创建时间", key: "CHUANGJIANRIQI" ,tooltip: true,width:100 },
]
...
export const tableAKEOApprovedTitle = [
  ...
  { props: "carType", name: "涉及车型/车型项目", key: "SHEJICHEXINGCHEXINGXIANGMU", tooltip: true, width:120 },
  { props: "supplier", name: "主要供应商", key: "LK_AEKO_ZHUYAOGONGYINGSHANG", tooltip: true,width:80  },
  { props: "EP1", name: "增加材料成本（RMB/车）", key: "LK_AEKO_ZENGJIACAILIAOCHENGBEN", tooltip: true,width:135 },
  { props: "EP2", name: "增加投资费用", key: "LK_AEKO_ZENGJIATOUZIFEIYONG", tooltip: true ,width:85},
  { props: "EP3", name: "其他费用", key: "LK_AEKO_QITAFEIYONG", tooltip: true ,width:60},
  { props: "DepartmentName", name: "科室", key: "LK_KESHI", tooltip: true,width:60 },
  { props: "buyerName", name: "采购员", key: "CAIGOUYUAN", tooltip: true },
  { props: "attach", name: "审批附件", key: "LK_AEKO_SHENPIFUJIAN", tooltip: true,width:60 },
  { props: "auditStatus", name: "审批状态", key: "LK_SHENPIZHUANGTAI", tooltip: true,width:60 },
