...
export const searchList = [
  ...
  {props:'type',label:'分派状态',type:'select',labelKey:'FENPAIZHUANGTAI',selectOption:'typeList',permissionKey:'AEKO_MANAGELIST_SELECT_BUYERNAME|Linie',filterable:true,clearable:true},
]
