...
export const searchList = [
  ...
  {props:'cartypeCode',label:'⻋型项⽬',type:'select',labelKey:'LK_AEKOCHEXINGXIANGMU',selectOption:'cartypeCode',filterable:true,noShowAll:true,clearable:true,multiple:true,},
