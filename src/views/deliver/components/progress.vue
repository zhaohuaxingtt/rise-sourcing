    ...
    <div class="carProject-progress">
      <div v-for="(item, index) in nodeList" :key="item.label" class="stepItem">
        <div class="stepItem-box">
          ...
          <!-- 正在进行中 -->
          <icon v-else-if="item.isDone == 2" symbol name="icondingdianguanlijiedian-jinhangzhong"
            class="step-icon  click-icon"></icon>
          <!-- 未完成 -->
        ...
        <span v-else-if="item.isDone == 1 && nodeList[index + 1].isDone == 2"
          v-html="svgList['iconchanpinzupaicheng_jinhangzhong']" class="step-between-icon"></span>
        <!-- 已完成 -->
        <!-- <icon v-else-if="item.isDone == 1" symbol name="iconchanpinzupaicheng_yiwancheng" class="step-between-icon"></icon> -->
        <span v-else-if="item.isDone == 1" v-html="svgList['iconchanpinzupaicheng_yiwancheng']"
          class="step-between-icon"></span>
        <!-- 未完成 -->
...
export default {
  ...
  data() {
    return {
      ...
      svgList: {
        ...
        'iconchanpinzupaicheng_yiwancheng': '<svg t="1631758321224" class="icon" viewBox="0 0 25600 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="66516" width="100%" height="100"><path d="M25108.07552 1024H492.65152A502.272 502.272 0 0 1 0.10752 512a502.272 502.272 0 0 1 492.544-512h24615.424A502.272 502.272 0 0 1 25600.10752 512a502.272 502.272 0 0 1-492.032 512z" fill="#67C23A" p-id="66517"></path></svg>',
        'iconchanpinzupaicheng_jinhangzhong': '<svg t="1631758354535" class="icon" viewBox="0 0 8704 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="76121" width="100%" height="100"><path d="M7750.236034 988.508727A213.63016 213.63016 0 0 1 7678.400333 824.020329V682.737763h-682.524474a170.631119 170.631119 0 1 1 0-341.262237h682.524474v-141.282566a213.63016 213.63016 0 0 1 71.835701-164.488398 143.500771 143.500771 0 0 1 153.568007-23.035201l690.885399 311.913684a216.701521 216.701521 0 0 1 0 375.388461l-690.885399 311.401791a141.453197 141.453197 0 0 1-58.526474 12.797334 147.93718 147.93718 0 0 1-95.041533-35.661904zM5289.564674 682.737763a170.631119 170.631119 0 0 1 0-341.262237h853.155593a170.631119 170.631119 0 1 1 0 341.262237zM3583.253489 682.737763a170.631119 170.631119 0 1 1 0-341.262237h853.155592a170.631119 170.631119 0 0 1 0 341.262237zM1876.942304 682.737763a170.631119 170.631119 0 1 1 0-341.262237h853.155592a170.631119 170.631119 0 1 1 0 341.262237zM170.631119 682.737763a170.631119 170.631119 0 1 1 0-341.262237h853.155592a170.631119 170.631119 0 1 1 0 341.262237z" fill="#67C23A" p-id="76122"></path></svg>',
        'iconchanpinzupaicheng_xuxian': '<svg t="1631758384625" class="icon" viewBox="0 0 28918 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="85726" width="100%" height="100"><path d="M28406.784 1024H26112a512 512 0 0 1-512-512 512 512 0 0 1 512-512h2294.784a512 512 0 0 1 512 512 512 512 0 0 1-512 512zM23552 1024h-2560a512 512 0 0 1-512-512 512 512 0 0 1 512-512h2560a512 512 0 0 1 512 512 512 512 0 0 1-512 512zM18432 1024h-2560a512 512 0 0 1-512-512 512 512 0 0 1 512-512h2560a512 512 0 0 1 512 512 512 512 0 0 1-512 512zM13312 1024h-2560a512 512 0 0 1-512-512 512 512 0 0 1 512-512h2560a512 512 0 0 1 512 512 512 512 0 0 1-512 512zM8192 1024h-2560a512 512 0 0 1-512-512 512 512 0 0 1 512-512h2560a512 512 0 0 1 512 512 512 512 0 0 1-512 512zM3072 1024H512a512 512 0 0 1-512-512 512 512 0 0 1 512-512h2560a512 512 0 0 1 512 512 512 512 0 0 1-512 512z" fill="#67C23A" p-id="85727"></path></svg>'
      }
    }
  },
  watch: {
  ...
  methods: {
     ...
     * @return {*}
     */
    async getProgressList(val = 50141107) {
      if (!val) {
        return
      }
      this.loading = false
