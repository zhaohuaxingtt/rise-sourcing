...
export const tabtitle = [
    ...
    {value: 2, message: 0, name: "预算审批", activePath: '/tooling/budgetApproval', url: '/tooling/budgetApproval', key: "LK_YUSUANSHENPI", permissionKey: '/TOOLING/BUDGETAPPROVAL'},
    {value: 3, message: 0, name: "BA申请", activePath: '/tooling/baApplyIndex', url: '/tooling/baApplyIndex', key: "LK_BASHENQING", permissionKey: '/TOOLING/BAAPPLYINDEX'},
    {value: 4, message: 0, name: "BM申请", activePath: '/tooling/bmApplyIndex', url: '/tooling/bmApplyIndex', key: "LK_BMSHENQING", permissionKey: '/TOOLING/BMAPPLYINDEX'},
    ...
    {value: 6, message: 0, name: "BA审批", activePath: '/tooling/baApprovalIndex', url: '/tooling/baApprovalIndex', key: "LK_BAAPPROVAL", permissionKey: '/TOOLING/BAAPPROVALINDEX'},
