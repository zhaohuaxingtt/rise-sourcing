...
import {bmAmountDetailList, form} from "../components/data";
import {pageMixins} from "@/utils/pageMixins";
import {tableHeight} from "@/utils/tableHeight";
import {getTousandNum} from "@/utils/tool";
import {bmAmountDetail} from "@/api/ws2/dataBase";
...
export default {
  ...
  props: {
    title: {type: String, default: 'MOULDADD.LK_YIBMJINE'},
