...
<template>
  <iPage class="orgationcheckHome">
    <el-tabs v-model="tab" class="tab">
      <el-tab-pane label="岗位管理" name="source">
        <div>
          <el-row>
            <el-col :span="12">
              <iCard class="icard-one">
                ...
                <!--                  table模块，向外入参表格数据，表头                    --->
                <!------------------------------------------------------------------------>
                <div class="margin-bottom20 clearFloat floatright">
                  <div class="font-weight font24">
            ...
            <el-col :span="12">
              <iCard class="icard-one margin-left">
                <!------------------------------------------------------------------------>
                <!--                  table模块，向外入参表格数据，表头                    --->
                <!------------------------------------------------------------------------>
...
import { tableTitle, tableTitleOfPost } from "./component/data";
...
export default {
  ...
  data() {
    return {
      ...
      tableTitle: tableTitle,
      tableTitleOfPost: tableTitleOfPost,
      tab: "source",
    };
  },
  created() {},
