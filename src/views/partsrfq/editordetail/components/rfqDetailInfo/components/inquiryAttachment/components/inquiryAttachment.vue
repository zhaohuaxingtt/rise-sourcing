  ...
  <iCard>
    <div class="margin-bottom20 clearFloat">
      ...
      <div class="floatright">
        <iButton @click="deleteItems" v-permission="PARTSRFQ_EDITORDETAIL_RFQDETAILINFO_INQUIRYATTACHMENT_INQUIRYATTACHMENT_DELETE">删除</iButton>
        <upload-button
        ...
        <iButton @click="notifyAllSuppliers" v-permission="PARTSRFQ_EDITORDETAIL_RFQDETAILINFO_INQUIRYATTACHMENT_INQUIRYATTACHMENT_NOTIFYALL">通知全部供应商</iButton>
        <!-- 暂不做，后端暂无接口：用户选择“通知已报价供应商”，系统会根据RFQ的报价记录，发给有有效报价的供应商-->
        <iButton @click="notifySuppliersWhoHaveQuoted" v-permission="PARTSRFQ_EDITORDETAIL_RFQDETAILINFO_INQUIRYATTACHMENT_INQUIRYATTACHMENT_NOTIFYQUOTED">通知已报价供应商</iButton>
      </div>
    </div>
    <tablelist
