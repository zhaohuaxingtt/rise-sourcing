...
<template>
  <div class="mainContent">
    <iTabsList type="card" slot="components" class='margin-top20' v-model="currentTab">
    ...
    <span class="buttonBox">
      <iButton v-if="currentTab == '1'" @click="clickReturn">返回</iButton>
      <iButton @click="clickReport">报告清单</iButton>
    </span>
  </div>
</template>
<script>
...
export default{
  components:{iTabsList,iCard,iButton,quotationScoringTracking,quotationScoringMj,quotationScoringHZ,quotationScoringEcartsCard,analysisTool,pcaOverview,buMonitor},
  data(){
    return {
      cardShow:icardData,
      currentTab: 1,
