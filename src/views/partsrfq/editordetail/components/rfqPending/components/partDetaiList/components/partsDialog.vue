 ...
 * @LastEditors: YoHo
 * @LastEditTime: 2022-02-18 15:15:37
 * @Description: 申请零件目标价
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      const params = this.selectList.filter(i=> i.cfController && i.applyType && (i.expectedTargetPrice!=undefined && i.expectedTargetPrice.trim()!=''))
