 ...
 * @LastEditTime: 2022-03-23 16:49:22
 * @LastEditors: YoHo
...
// export const tableTitle = permissionTitle("PARTSRFQ_RFQLIST", [
    { props: 'id', name: 'RFQ编号', key: 'RFQBIANHAO', tooltip: true, width:100 },
    ...
    { props: 'currentRounds', name: '当前轮次', key: 'DANGQIANLUNCI', tooltip: true, width:100 },
    { props: 'suppliers', name: '已报价/已询价供应商', key: 'YIBAOJIA_YIXUNJIA_GONGYINGSHANG', tooltip: true,width:170 },
    ...
    { props: 'currentRoundsEndTime', name: '报价截至日期', key: 'BAOJIAJIEZHIRIQI', tooltip: true,width:120},
    { props: 'buyerName', name: '询价采购员', key: 'XUNJIACAIGOUYUAN', tooltip: true, width:100 },
    { props: 'linieNameZh', name: 'LINIE', key: 'LINIE', tooltip: true,width:100 },
    { props: 'tpGradeStatus', name: '技术评分状态', key: 'JISHUPINGFENZHUANGTAI', tooltip: true, width: 130 },
    { props: 'mqGradeStatus', name: '质量评分状态', key: 'ZHILIANGPINGFENZHUANGTAI', tooltip: true, width: 130 },
    { props: 'targetGradeStatus', name: '财务目标价状态', key: 'CAIWUMUBIAOJIAZHUANGTAI', tooltip: true, width: 130 },
