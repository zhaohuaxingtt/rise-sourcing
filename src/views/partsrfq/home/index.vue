 ...
 * @LastEditTime: 2021-06-30 10:28:09
            ...
            <div class="margin-bottom20 clearFloat">
              ...
              <div class="floatright">
                ...
                <iButton @click="editRfq('02')" :loading="activateButtonLoading" v-permission="PARTSRFQ_ACTIVATERFQ">
                  {{ language('LK_JIHUORFQ','激活RFQ') }}
                </iButton>
                <!--新建RFQ：点击该键，系统会跳到下一界面。具体新建RFQ见另一user story，当RFQ类型为FS时，仅前期采购员有该按钮权限-->
                <iButton @click="newRfq" v-permission="PARTSRFQ_NEWRFQ">{{ language('LK_XINJIANRFQ','新建RFQ') }}</iButton>
                ...
                <iButton @click="exportTable" v-permission="PARTSRFQ_EXPORT">{{ language('LK_DAOCHU','导出') }}</iButton>
              </div>
            </div>
            <tablelist
