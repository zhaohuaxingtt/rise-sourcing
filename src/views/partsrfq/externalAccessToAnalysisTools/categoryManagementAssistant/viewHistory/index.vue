        ...
        <el-form class="queryForm">
          <el-form-item label="材料组">
            <iSelect v-model="form.categoryCode"
                     filterable
                     placeholder="请选择">
              <el-option v-for="item in formGoup.categoryList"
          ...
          <el-form-item label="年份">
            ...
            <div style="width:17rem"
              ...
              <iDatePicker v-model="form.startYear"
                           format="yyyy"
                           value-format="yyyy"
                           type="year"
                           :placeholder="language('KAISHINIANFENG','开始年份')"
                           clearable
                           :picker-options="pickerStartAuditYear" />
              -
              <iDatePicker v-model="form.endYear"
                           format="yyyy"
                           value-format="yyyy"
                           type="year"
                           :placeholder="language('JIESHUNIANFENG','结束年份')"
                           clearable
