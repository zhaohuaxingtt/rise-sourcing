...
-->
<template>
  <iCard :title='language("HANGYEBAOGAO","行业报告")'
         class="margin-top20">
    ...
    <tableList :tableData="tableListData"
      ...
      <template #reportName="scope">
        <iInput v-model="scope.row.reportName"
                v-if="isEdit"></iInput>
...
import { downloadFile, downloadUdFile, getFileByFileId } from '@/api/file';
