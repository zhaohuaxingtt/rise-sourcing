 ...
 * @LastEditTime: 2021-09-08 10:36:39
...
export default {
  ...
  methods: {
    ...
    handleChange (val) {
      localStorage.setItem('compareCarType', val)
    },
    // 数据字典
    getDict () {
    ...
    carTypeByCategoryCode () {
      ...
      this.filterCarValue = localStorage.getItem('compareCarType').split(',')
    },
    // 重置
    reset () {
      this.selectDate = []
