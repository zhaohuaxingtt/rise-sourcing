...
<template>
  <iCard>
    <el-row type="flex" justify="space-between" align="middle">
      ...
      <el-col :span="20">
        <tableList :height="100" class="margin-top20" :tableData="tableListData" :tableTitle="tableTitle" :tableLoading="tableLoading" :selection='false' :index="false" @handleCurrentChange="handleCurrentChange">
        </tableList>
      </el-col>
    </el-row>
...
export default {
  ...
  watch: {
    object: {
      deep: true,
      handler(data) {
        this.tableListData = data.categoryVOList
      }
    }
  },
  // 方法集合
