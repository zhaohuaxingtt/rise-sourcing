 ...
 * @LastEditTime: 2021-08-04 16:17:47
...
<template>
  <iPage>
     <div class="overView flex-between-center">
        <iCard class="icard" :title='language(item.key,item.name)' v-for="(item,index) in list" :key="index">
        ...
        list:[
           {
              ...
              image:"iconAekojianzhiBMdanweixuanzhong"
           },
           {
              name:"产量总览",
              key:"CAILIANGZONGLAN",
