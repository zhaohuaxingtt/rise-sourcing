 ...
 * @LastEditTime: 2021-12-28 19:47:23
...
<template>
  <iCard
    ...
    <pointTable v-if="value==1"
                ref="pointTable"
                :searchCriteria="searchCriteria"></pointTable>
    <supplierTable v-else
                   ref="supplierTable"
                   :searchCriteria="searchCriteria"></supplierTable>
  </iCard>
</template>
...
export default {
  ...
  methods: {
    ...
    exportTemplate () {
      ...
      excelExport(tableData, this.tableTitleExport, this.language('DINGDIANLISHIJILU', '定点历史记录'))
    },
    // 查询字典
    getDict () {
