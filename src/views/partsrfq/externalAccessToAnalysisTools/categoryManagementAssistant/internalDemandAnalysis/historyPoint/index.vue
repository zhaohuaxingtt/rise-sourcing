 ...
 * @LastEditTime: 2021-08-11 14:42:48
 * @LastEditors: 舒杰
 * @Description: 定点历史记录
	...
	<iCard :title='language("DINGDIANLISHIJILV","定点历史记录")' class="margin-top20">
		...
		<div class="flex-between-center">
			...
			<div class="flex-align-center">
				<iSelect class="margin-right10" :placeholder='language("QXZGYSMC", "请选择供应商名称")' v-if="value==2"></iSelect>
				<iSelect class="margin-right10" :placeholder='language("QXZDDSJ", "请选择定点时间")'>
		...
		<pointTable v-if="value==1" ref="pointTable"></pointTable>
		<supplierTable v-else ref="supplierTable"></supplierTable>
	</iCard>
</template>
