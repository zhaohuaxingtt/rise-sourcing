      ...
      <div class="searchBox">
        <el-form :inline="true"
          ...
          <el-form-item style="width: 220px; marginRight: 53px;"
            ...
            <iDatePicker v-model="searchForm['date']"
                         valueFormat="yyyy-MM-dd"
                         type="daterange"></iDatePicker>
          </el-form-item>
          <el-form-item style="width: 220px; marginRight: 53px;">
            <span slot="label">
              {{language('ZUIJINNCIDINGDIANSHU', '最近n次定点数（n≤50）')}}
              <el-tooltip :content="language('ZUIDASHAIXUANFANWEI', '最大筛选范围：50次')"
                          placement="top"
                          effect="light">
                <i class="el-icon-warning-outline rotate"></i>
              </el-tooltip>
            </span>
            <iInput v-positive="'num'"
                    v-model="searchForm['nomiNum']"
                    :placeholder="language('QINGSHURU', '请输入')"
                    @change="handleNomiNumChange($event)"></iInput>
          </el-form-item>
          <el-form-item style="width: 220px; marginRight: 53px;"
          ...
          <el-form-item class="searchButton">
            ...
            <el-button style="marginRight: -8px;"
                       @click="handleSearchReset">{{language('CHONGZHI', '重置')}}</el-button>
          </el-form-item>
        </el-form>
      </div>
