 ...
 * @LastEditTime: 2021-06-17 20:35:06
...
export default {
  ...
  methods: {
    ...
    initTestTableData() {
      this.tableListData = [
        {id: 0, name: 'test1', materials: '一号材料组', default: 0, stick: true, children: [
          {id: 1, name: 'test1.1', materials: '二号材料组'},
          {id: 2, name: 'test1.2', materials: '三号材料组', children: [
            {id: 4, name: 'test1.2.1', materials: '五号材料组'},
          ]},
        ]},
        {id: 3, name: 'test2', materials: '四号材料组', default: 1, stick: false},
      ]
