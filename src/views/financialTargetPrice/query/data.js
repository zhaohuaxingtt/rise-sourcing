 ...
 * @LastEditTime: 2021-09-08 10:01:35
 * @Description: 
...
export const searchList = [
  {value: 'fsNum', label: 'FsNr/GsNr', type: 'input', i18n_label: 'FSNRGSNR',permission: 'FINANCIALTARGETPRICE_QUERY_FSNUM|财务目标价管理-目标价查询-FSGSNO'},
  ...
  {value: 'applyStats', label: '申请状态', type: 'select', i18n_label: 'SHENQINGZHUANGTAI',selectOption:'CF_APPLY_STATUS',permission: 'FINANCIALTARGETPRICE_QUERY_APPLYSTATS|财务目标价管理-目标价查询-申请状态'},
  ...
  {value: 'cfPriceType', label: '目标价分类', type: 'select', i18n_label: 'MUBIAOJIAFENLEI',selectOption: 'CF_PRICE_TYPE',permission: 'FINANCIALTARGETPRICE_QUERY_PRICETYPE|财务目标价管理-目标价查询-目标价分类'},
  ...
  {value: 'approveStats', label: '审批状态', type: 'select', i18n_label: 'SHENPIZHUANGTAI',selectOption: 'CF_APPROVE_STATUS',permission: 'FINANCIALTARGETPRICE_QUERY_APPROVESTATS|财务目标价管理-目标价查询-审批状态'},
  ...
  {value: 'assignStats', label: '指派状态', type: 'select', i18n_label: 'ZHIPAIZHUANGTAI',selectOption: 'CF_ASSIGN_START',permission: 'FINANCIALTARGETPRICE_QUERY_ASSIGNSTATS|财务目标价管理-目标价查询-指派状态'}
]
