 ...
 * @LastEditTime: 2022-01-11 16:54:47
...
export const addDialogFrom=[
  ...
  {props:'rateDepartNum',label:'评分股',labelKey:'CONFIGSCOREDEPT_PINGFENGU',type:'select',selectOption:'b',required:true,isShow:true},
  {props:'rateDepart',label:'所属部门/科室',labelKey:'CONFIGSCOREDEPT_SUOSHUBUMENHUOZHEKESHI',isBoolean:true,required:true,isShow:true},
