...
export const searchList = [
  {value: 'partNumFuzzySearch', label: '配件零件号', type: 'multiLineInput', key: 'PEIJIANLINGJIANHAO',permission: 'APREPART_SIGN_PARTNUM|配件-配件签收-配件零件号'},
  ...
  {value: 'assemblyPartNumFuzzySearch', label: '批量供货总成号', type: 'multiLineInput', key: 'PILIANGGONGHUOZONGCHENGHAO',permission: 'APREPART_SIGN_ASSEMBLYPARTNUM|配件-配件签收-批量供货总成号'},
  {value: 'spNumFuzzySearch', label: 'SP号', type: 'multiLineInput', key: 'SPHAO',permission: 'APREPART_SIGN_SPNUM|配件-配件签收-SP号'},
  {value: 'sparePartCodeFuzzySearch', label: '编号', type: 'multiLineInput', key: 'BIANHAO',permission: 'APREPART_SIGN_CODE|配件-配件签收-编号'},
