...
export const searchList = [
  ...
  {value: 'carType', label: '配件车型', type: 'select', i18n_label: '',selectOption: 'cartTypeOptions'},
  {value: 'carProject', label: '配件车型项目', type: 'select', i18n_label: '',selectOption: 'carTypeProjectOptions'},
