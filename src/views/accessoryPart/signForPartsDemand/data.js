 ...
 * @LastEditTime: 2021-06-25 13:14:07
 * @Description: 
...
export const tableTitle = [
  ...
  {props:'partNameCh',name:'配件零件中文名', key: "PEIJIANLINGJIANZHONGWENMING", tooltip: true, width: 120},
  ...
  {props:'supplierNameZh',name:'供应商中文名', key: "GONGYINGSHANGZHONGWENMING", tooltip: true, width: 120},
  ...
  {props:'csfuserIdName',name:'询价采购员', key: "XUJIACAIGOUYUAN", tooltip: true, width: 100},
  ...
  {props:'partNameDe',name:'配件零件德文名', key: "PEIJIANLINGJIANDEWENMING", tooltip: true, width: 120},
  {props:'supplierSvwTempCode',name:'供应商临时号', key: "GONGYINGSHANGLINGSHIHAO", tooltip: true, width: 120},
  {props:'carProject',name:'配件车型项目', key: "PEIJIANCHEXINGXIANGMU", tooltip: true, width: 120},
  {props:'technicianStaffName',name:'售后技术人员名称', key: "SHOUHOUJISHURENYUANMINGCHENG", tooltip: true, width: 120},
