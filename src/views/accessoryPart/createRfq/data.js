...
export const basicInfo = [
  ...
  {value: 'currentStatus', label: 'RFQ状态', type: 'input', key: 'RFQZHUANGTAI', editable: false, permission: 'ACCESSORYPART_CREATERFQ_RFQSTATUS|配附件创建RFQ-RFQ状态'},
  ...
  {value: 'createDateTime', label: 'RFQ创建日期', type: 'input', key: 'RFQCHUANGJIANRIQI', editable: false, permission: 'ACCESSORYPART_CREATERFQ_RFQCREATEDATE|配附件创建RFQ-RFQ创建日期'},
