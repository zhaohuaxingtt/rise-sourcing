 ...
 * @LastEditTime: 2021-05-25 16:22:53
 * @Description: 
 * @FilePath: \front-web\src\views\accessoryPart\components\signForPartsDemand\index.vue
-->
...
<script>
import { iPage, iSearch, iSelect, iInput, iCard, iButton, iPagination, iDatePicker, iMessage } from 'rise'
...
export default {
  mixins: [pageMixins],
  components: { iPage, iSearch, iSelect, iInput, iCard, iButton, iPagination, tableList, iDatePicker, assignInquiryDepartmentDialog, assignInquiryBuyerDialog, backDialog },
  data() {
    return {
