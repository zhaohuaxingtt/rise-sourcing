...
export const letterAndLoiType = [
    {label:'LK_DINGDIANXIN',key:'letter',name:'定点信', permissionKey: 'LK_LETTERANDLOI_LETTER_PAGE|定点信页面'},
    {label:'LK_LOI',key:'LOI',name:'LOI', permissionKey: 'LK_LETTERANDLOI_LOI_PAGE|LOI页面'},
]
