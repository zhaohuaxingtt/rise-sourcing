 ...
 * @LastEditTime: 2021-11-03 14:47:18
 * @Description: 
 * @FilePath: \front-web\src\views\modelTargetPrice\query\data.js
 */


export const tableTitle = [
  {props:'fsnrGsnrNum',name:'零件采购项目号', key: "FSGSSPNO", tooltip: true, width: 130},
  {props:'partNum',name:'零件号', key: "LINGJIANHAO", tooltip: true, width: 120},
  {props:'partNum',name:'采购工厂', key: "CAIGOUGONGCHANG", tooltip: true, width: 120},
  {props:'partNameZh',name:'零件名(中)', key: "LINGJIANMINGCHENGZHONG", tooltip: true, width: 120},
  {props:'partNameZh',name:'零件名(德)', key: "LINGJIANMINGCHENGDE", tooltip: true, width: 120},
  {props:'partNum',name:'车型项目', key: "CHEXINGXIANGMU", tooltip: true, width: 120},
  ...
  {props:'expTargetpri',name:'目标价', key: "MUBIAOJIA", tooltip: true},
  ...
  {props:'isAssignDesc',name:'状态', key: "ZHUANGTAI", tooltip: true},
]
...
export const searchList = [
  ...
  {value: 'partName', label: '零件名称', type: 'input', i18n_label: 'LINGJIANMINGCHENG',permission: 'MODELTARGETPRICE_QUERY_PARTNAME|模具目标价管理-目标价查询-零件名称'},
  ...
  {value: 'carTypeName', label: '车型项目', type: 'carProjectSelect', i18n_label: 'CHEXINGXIANGMU', selectOption: 'CAR_TYPE_PRO',permission: 'MODELTARGETPRICE_QUERY_CARPROJECT|模具目标价管理-目标价查询-车型项目'},
  {value: 'procureFactoryId', label: '采购工厂', type: 'procureFactorySelect', i18n_label: 'LKCAIGOUGONGCHANG', selectOption: 'PURCHASE_FACTORY',permission: 'MODELTARGETPRICE_QUERY_PROFACTORY|模具目标价管理-目标价查询-采购工厂'},
  ...
  {value: 'cfId', label: '模具控制员', type: 'input', i18n_label: 'MOJUKONGZHIYUAN',selectOption:'CF_USER',permission: 'MODELTARGETPRICE_QUERY_CF|模具目标价管理-目标价查询-CF'},
  {value: 'applyStats', label: '申请类型', type: 'selectDict', i18n_label: 'SHENQINGZHUANGTAI',selectOption:'',permission: 'MODELTARGETPRICE_QUERY_APPLYTYPE|模具目标价管理-目标价查询-申请类型'},
  ...
  {value: 'assignStats', label: '状态', type: 'selectDict', i18n_label: 'ZHUANGTAI',selectOption: '',permission: 'MODELTARGETPRICE_QUERY_STATS|模具目标价管理-目标价查询-状态'}
]
