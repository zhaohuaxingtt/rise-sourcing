...
export const tableTitle = [
  { props: 'fsNum', name: '零件采购项目号', key: "FSGSSPNO", tooltip: true, width: 145, sortable: true, fixed: true },
  { props: 'partNum', name: '零件号', key: "LINGJIANHAO", tooltip: true, width: 120, sortable: true, fixed: true },
  { props: 'procureFactoryName', name: '采购工厂', key: "CAIGOUGONGCHANG", tooltip: true, width: 120, sortable: true, fixed: true },
  { props: 'partNameZh', name: '零件名(中)', key: "LINGJIANMINGCHENGZHONG", tooltip: true, width: 135, sortable: true, fixed: true },
  { props: 'partNameDe', name: '零件名(德)', key: "LINGJIANMINGCHENGDE", tooltip: true, width: 120, sortable: true, fixed: true },
  { props: 'cartypeProjectZh', name: '车型项目', key: "CHEXINGXIANGMU", tooltip: true, width: 120, sortable: true, fixed: true },
  { props: 'rfqId', name: 'RFQ编号', key: "RFQBIANHAO", tooltip: true, width: 110, sortable: true, fixed: true },
  ...
  { props: 'cfName', name: 'CF', key: "CF", tooltip: true, width: 120, sortable: true, fixed: true },
...
export const searchList = [
  ...
  { value: 'partNum', label: '零件号', type: 'multiLineInput', i18n_label: 'LINGJIANHAO', permission: 'MODELTARGETPRICE_QUERY_PARTNUM|模具目标价管理-目标价查询-零件号' },
  ...
  { value: 'cartypeProjectId', label: '车型项目', type: 'carProjectSelect', i18n_label: 'CHEXINGXIANGMU', selectOption: 'CAR_TYPE_PRO', permission: 'MODELTARGETPRICE_QUERY_CARPROJECT|模具目标价管理-目标价查询-车型项目' },
  ...
  { value: 'showSelf', label: '显示自己', type: 'select', selectOption: "showSelfOptions", i18n_label: 'XIANSHIZIJI', permission: 'MODELTARGETPRICE_QUERY_SHOWSELF|模具目标价管理-目标价查询-显示自己' },
]
