...
export default {
  mixins: [pageMixins],
  components: {iDicoptions,procureFactorySelect,iPage,headerNav,iCard,tableList,iPagination,iButton,iSelect,iDatePicker,iInput,iSearch,attachmentDialog,approvalRecordDialog, carProjectSelect, iMultiLineInput},
  data() {
    return {
      tableTitle: tableTitle,
      tableData: [],
