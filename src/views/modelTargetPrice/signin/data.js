 ...
 * @LastEditTime: 2021-11-03 14:41:55
 * @Description: 
 * @FilePath: \front-web\src\views\modelTargetPrice\signin\data.js
 */
...
export const tableTitle = [
  ...
  {props:'priceAnaName',name:'CF', key: "CF", tooltip: true},
  {props:'applyDate',name:'申请日期', key: "SHENQINGRIQI", tooltip: true},
  {props:'applyDateEnd',name:'截止日期', key: "JIEZHIRIQI", tooltip: true},
  {props:'approveStatusDesc',name:'签收状态', key: "QIANSHOUZHUANGTAI", tooltip: true},
...
export const searchList = [
  ...
  {value: 'partName', label: '零件名称', type: 'input', i18n_label: 'LINGJIANMINGCHENG',permission: 'MODELTARGETPRICE_SIGNIN_PARTNAME|模具目标价管理-目标价签收-零件名称'},
  ...
  {value: 'carTypeName', label: '车型项目', type: 'carProjectSelect', i18n_label: 'CHEXINGXIANGMU', selectOption: 'CAR_TYPE_PRO',permission: 'MODELTARGETPRICE_SIGNIN_CARTYPE|模具目标价管理-目标价签收-车型项目'},
  {value: 'procureFactoryId', label: '采购工厂', type: 'procureFactorySelect', i18n_label: 'LKCAIGOUGONGCHANG', selectOption: 'PURCHASE_FACTORY',permission: 'MODELTARGETPRICE_SIGNIN_PROCUREFACTORY|模具目标价管理-目标价签收-采购工厂'},
  ...
  {value: 'cfId', label: '模具控制员', type: 'input', i18n_label: 'MOJUKONGZHIYUAN',selectOption:'CF_USER',permission: 'MODELTARGETPRICE_SIGNIN_CF|模具目标价管理-目标价签收-CF'},
  {value: 'cfPriceType', label: '申请类型', type: 'selectDict', i18n_label: 'SHENQINGLEIXING',selectOption: '',permission: 'MODELTARGETPRICE_SIGNIN_APPLYTYPE|模具目标价管理-目标价签收-申请类型'},
