 ...
 * @LastEditors: YoHo
 * @LastEditTime: 2022-03-25 15:37:04
 * @Description: 
...
export const searchList = [
  ...
  { value: 'partNum', label: '零件号', type: 'multiLineInput', i18n_label: 'LINGJIANHAO', permission: 'MODELTARGETPRICE_APPROVAL_PARTNUM|模具目标价管理-目标价审批-零件号' },
  ...
  { value: 'cartypeProjectId', label: '车型项目', type: 'carProjectSelect', i18n_label: 'CHEXINGXIANGMU', selectOption: 'CAR_TYPE_PRO', permission: 'MODELTARGETPRICE_APPROVAL_CARPROJECT|模具目标价管理-目标价审批-车型项目' },
