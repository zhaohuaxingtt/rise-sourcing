 ...
 * @LastEditTime: 2021-09-07 16:51:37
...
<template>
  <iPage class="dashboard">
    <headerNav v-permission.auto="DASHBOARD_PARTSIGN_PAGE|寻源概览" />
    <!-- 功能卡片 -->
    <div class="dashboard-card">
      <el-row :gutter="10">
        <!-- 零件签收 -->
        <el-col :span="4" v-permission.auto="DASHBOARD_PARTSIGN|寻源概览-零件签收">
          <iCard :tabCard="false">
        ...
        <!-- 采购项目建立 -->
        <el-col :span="4" v-permission.auto="DASHBOARD_PARTSPROCURE|寻源概览-采购项目建立">
          <iCard :tabCard="false">
            <div class="dashboard-card-header" slot="header">
              <icon symbol name="icona-dingdianguanlijiedian-yiwancheng-fuben" class="cardicon"></icon>
        ...
        <!-- RFQ管理 -->
        <el-col :span="8" v-permission.auto="DASHBOARD_RFQMGMT|寻源概览-RFQ管理">
          <iCard :tabCard="false">
            <div class="dashboard-card-header" slot="header">
              <icon symbol name="icona-dingdianguanlijiedian-yiwancheng-fuben" class="cardicon"></icon>
        ...
        <!-- 定点管理 -->
        <el-col :span="4" v-permission.auto="DASHBOARD_NOMINATEMGMT|寻源概览-定点管理">
          <iCard :tabCard="false">
            <div class="dashboard-card-header" slot="header">
              <icon symbol name="icona-dingdianguanlijiedian-yiwancheng-fuben" class="cardicon"></icon>
        ...
        <!-- 定点信/LOI -->
        <el-col :span="4" v-permission.auto="DASHBOARD_NOMILETTERANDLOI|寻源概览-定点信/LOI">
          <iCard :tabCard="false">
            <div class="dashboard-card-header" slot="header">
              <icon symbol name="icona-dingdianguanlijiedian-yiwancheng-fuben" class="cardicon"></icon>
    ...
    <div class="dashboard-charts">
      <el-row :gutter="10">
        <!-- 材料组定点时率及平均定点周期 -->
        <el-col :span="16" v-permission.auto="DASHBOARD_MATERIALANDNOMIRATE|寻源概览-材料组定点及时率及平均定点周期">
          <nomicharts :data="materialGroupData" v-loading="loading" />
        </el-col>
        <el-col :span="8" v-permission.auto="DASHBOARD_CIRCULATIONOVERVIEW|寻源概览-流转状态跟踪">
