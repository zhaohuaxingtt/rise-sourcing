    ...
    <el-form>
      ...
      <el-form-item :label="language('nominationLanguage_CheXingXiangMu','车型项目')">
        <iSelect
          ...
          v-permission.auto="REPORTMGMT_STATUSREPORT_PROCESS_CARTYPE|报表管理-车型项目"
      ...
      <el-form-item :label="language('nominationLanguage_LingJianHao', '零件号')">
        <iInput
          ...
          v-permission.auto="REPORTMGMT_STATUSREPORT_PROCESS_PARTNUM|报表管理-零件号"
      ...
      <el-form-item :label="language('strategicdoc_PaiXu','排序')">
        <iSelect
          class="select-control"
          v-model="form.order"
          v-permission.auto="REPORTMGMT_STATUSREPORT_PROCESS_SORT|报表管理-排序"
          :placeholder="language('LK_QINGXUANZE','请选择')"
      ...
      <el-form-item :label="language('LK_CAILIAOZU','材料组')">
        <iSelect
          ...
          v-permission.auto="REPORTMGMT_STATUSREPORT_PROCESS_MATERIAL|报表管理-材料组"
          multiple
          :placeholder="language('LK_QINGXUANZE','请选择')"
      ...
      <el-form-item :label="language('CAIGOUYUAN','采购员')">
        <iSelect
          class="select-control"
          v-model="form.buyer"
          v-permission.auto="REPORTMGMT_STATUSREPORT_PROCESS_BUYERL|报表管理-采购员"
          :placeholder="language('LK_QINGXUANZE','请选择')"
