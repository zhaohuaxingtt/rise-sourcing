 ...
 * @LastEditTime: 2021-03-31 17:35:35
...
<template>
  ...
  >
        ...
        <div class="row">
          <div class="col">
            ...
            <iFormItem label="Common Sourcing：" name="test">
              <iSelect
                v-model="detailData.commonSourcing"
          ...
          <div class="col">
            ...
            <iFormItem :label="$t('LK_LINGJIANLEIXING') + ':'" name="test">
              <iSelect
                v-model="detailData.partType"
                v-permission="PARTSPROCURE_EDITORDETAIL_PARTTYPE"
              >
                <el-option
                  :value="item.key"
                  :label="item.name"
                  v-for="(item, index) in getGroupList('all_part_type')"
                  :key="index"
                ></el-option>
              </iSelect>
            </iFormItem>
            <iFormItem :label="$t('LK_DANWEI') + ':'" name="test">
              <iSelect
                ...
                v-permission="PARTSPROCURE_EDITORDETAIL_UNIT"
              >
                <el-option
                  :value="item.key"
                  :label="item.name"
                  v-for="(item, index) in getGroupList('all_unit')"
                  :key="index"
                ></el-option>
              </iSelect>
            </iFormItem>
            <iFormItem :label="$t('LK_MTZLINGJIAN') + ':'" name="test">
              <iSelect
                v-model="detailData.mtz"
                v-permission="PARTSPROCURE_EDITORDETAIL_MTZPARTS"
              >
                <!-- <el-option :value="item.key" :label="item.name"
          ...
          <div class="col">
            ...
            >
              <iSelect
                ...
                v-permission="PARTSPROCURE_EDITORDETAIL_CURRENCY"
              >
                <el-option
                  :value="item.key"
                  :label="item.name"
          ...
          <div class="col">
            ...
            <iFormItem
              :label="$t('partsprocure.PARTSPROCUREPARTSTATUSNAME') + ':'"
              name="test"
            >
    ...
    <iTabsList class="margin-top20" type="border-card">
      ...
      <el-tab-pane
        :label="$t('LK_TUZHIHETPDANXIANGQING')"
      ...
      <el-tab-pane
        :label="$t('LK_WULIUYAOQIU')"
        v-permission="PARTSPROCURE_EDITORDETAIL_LOGISTICSREQUIREMENTS"
      >
        <logistics :infoItem="infoItem"></logistics>
      </el-tab-pane>
      <el-tab-pane
        :label="$t('LK_SHENQINGMUBIAOJIA')"
        v-permission="PARTSPROCURE_EDITORDETAIL_APPLYFORTARGETPRICE"
      >
        <targePrice :purchaseProjectId="purchasePrjectId"></targePrice>
      </el-tab-pane>
      <el-tab-pane
        :label="$t('LK_BEIZHUXINXI')"
        v-permission="PARTSPROCURE_EDITORDETAIL_REMARKSINFORMATION"
      >
