 ...
 * @LastEditTime: 2022-02-17 15:06:55
 * @LastEditors: YoHo
				...
				<div class="row">
					...
					<div class="col">
						...
						<iFormItem v-permission.auto="PARTSPROCURE_EDITORDETAIL_LINE|LINIE" label="LINIE：" name="test">
							...
							<iSelect v-model="detailData.linieId" filterable placeholder='请先选择LINIE部门' v-if="!disabled && (detailData.status != getEnumValue('PURCHASE_PROJECT_STATE_ENUM.HAS_RFQ'))">
