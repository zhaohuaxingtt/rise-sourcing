...
export const tableTitle = [
  { props: 'fsnrGsnrNum', name: 'FSNR/OSNR/SPNR', key: 'FSNR/OSNR/SPNR', tooltip: true },
  { props: 'partNum', name: '原零件号', key: 'YUANLINGJIANHAO', tooltip: true },
  { props: 'partNameCn', name: '零件名（中）', key: 'LINGJIANMINGZHONG', tooltip: true },
  { props: 'partNameDe', name: '零件名（德）', key: 'LINGJIANMINGDE', tooltip: true },
  { props: 'supplierSapCode', name: '供应商SAP号', key: 'GONGYSSAPHAO', tooltip: true },
