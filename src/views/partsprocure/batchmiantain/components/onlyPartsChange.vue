...
<template>
  <iCard>
    <div class="btn-right">
      <!-- 手工采购项目创建 -->
      <batch-miantain-output-plan :planItems="selectTions" @getDataList="getDataList" v-permission.auto="PARTSPROCURE_BATCHMANTAINCEPRODUCTPLAN|批量维护产量计划"></batch-miantain-output-plan>
    </div>
