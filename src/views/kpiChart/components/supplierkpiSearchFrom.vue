                ...
                <el-col :span="6">
                  ...
                  <div class="TOCase">
                    <iInput placeholder="请输入"
                            ...
                            @input="formData.spiSupplierDTO.toAmountStart=formData.spiBaseDTO.toAmountStart,supplierStart=formData.spiBaseDTO.toAmountStart"></iInput>
                    <span>-</span>
                    <iInput placeholder="请输入"
                            v-model="formData.spiBaseDTO.toAmountEnd"
                            @input="formData.spiSupplierDTO.toAmountEnd=formData.spiBaseDTO.toAmountEnd,supplierEnd=formData.spiBaseDTO.toAmountEnd"></iInput>
                  </div>
                </el-col>
              </el-row>
            </el-form>
                ...
                <el-col :span="6">
                  ...
                  <div class="TOCase">
                    <iInput placeholder="请输入"
                            ...
                            @change="handleToStart"></iInput>
                    <span>-</span>
                    <iInput placeholder="请输入"
                            v-model="supplierEnd"
                            @change="handleToEnd"></iInput>
                  </div>
                </el-col>
                <el-col :span="12">
...
<script>
import { iButton, iPage, iCard, iFormItem, iInput, iSelect, iDatePicker,iSelectCustom } from 'rise'
