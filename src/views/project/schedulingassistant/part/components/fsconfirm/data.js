 ...
 * @LastEditTime: 2021-08-27 10:16:37
 * @Description: 
...
export const tableTitleNomi = [
  ...
  {props:'partNum',name:'零件号', key: "CHANPINZUZHONGWENMINGCHENG", tooltip: true},
  {props:'partName',name:'零件中文名称', key: "CHANPINZUDEWENMINGCHENG", tooltip: true},
  {props:'isBmg',name:'是否BMG', key: "CHANPINZUZHONGWENMINGCHENG", tooltip: true},
  ...
  {props:'confirmDateDeadline',name:'确认截止日期', key: "QUERENJIEZHIRIQI", tooltip: true, editable: true, type: 'date'},
]
