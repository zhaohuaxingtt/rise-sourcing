...
<template>
    <el-table :row-key="rowKey" ref="multipleTable" fit tooltip-effect='light' :border="border" :height="height" :data='tableData' v-loading='tableLoading' @selection-change="handleSelectionChange" :empty-text="language('ZANWUSHUJU', '暂无数据')" @select="handleSelect"  @select-all="handleSelectAll" :cell-style="borderLeft" >
      <el-table-column :reserve-selection="true" v-if="selection" type='selection' width="58" align='center' :fixed="selectionFixed"></el-table-column>
