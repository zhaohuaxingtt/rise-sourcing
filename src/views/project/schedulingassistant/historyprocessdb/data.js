...
export const searchListPro = [
  ...
  {value: 'partNum', name: '零件号', key: 'LINGJIANHAO', type: 'multiLineInput', placeholder: '输入零件号搜索', placeholderKey: 'SHURULINGJIANHAOSOUSUO', permission: 'PROJECTMGT_SCHEDULINGASSISTANT_HISTORYPROCESSDB_PARTNUM|项目管理-排程助手-历史进度数据库-零件号'},
...
export const partTableTitle = [
  ...
  {props:'productGroupZh',name:'产品组中文名称', key: "CHANPINZUZHONGWENMINGCHENG", tooltip: true, isSelect: true, disabled: true, minWidth: 150},
  {props:'productGroupDe',name:'产品组德文名称', key: "CHANPINZUDEWENMINGCHENG", tooltip: true, isSelect: true, disabled: true, checkWidth: '54%', minWidth: 150},
  ...
  {props:'isttryoutDelay',name:'1st tryout是否延误', key: "1STTRYOUTSHIFOUYANWU", tooltip: true, isSelect: true, minWidth: 180},
  {props:'isttryoutReason',name:'1st tryout延误原因', key: "1STTRYOUTYANWUYUANYIN", tooltip: true, isSelect: true, minWidth: 180},
  ...
  {props:'emDelay',name:'EM是否延误', key: "EMSHIFOUYANWU", tooltip: true, isSelect: true, minWidth: 150},
  {props:'emReason',name:'EM延误原因', key: "EMYANWUYUANYIN", tooltip: true, isSelect: true, minWidth: 150},
  ...
  {props:'otsDelay',name:'OTS是否延误', key: "OTSSHIFOUYANWU", tooltip: true, isSelect: true, minWidth: 150},
  {props:'otsReason',name:'OTS延误原因', key: "OTSYANWUYUANYIN", tooltip: true, isSelect: true, minWidth: 150},
  ...
  {props:'q1Delay',name:'Q1是否延误', key: "Q1SHIFOUYANWU", tooltip: true, isSelect: true, minWidth: 150},
  {props:'q1Reason',name:'Q1延误原因', key: "Q1YANWUYUANYIN", tooltip: true, isSelect: true, minWidth: 150},
  ...
  {props:'q3Delay',name:'Q3是否延误', key: "Q3SHIFOUYANWU", tooltip: true, isSelect: true, minWidth: 150},
  {props:'q3Reason',name:'Q3延误原因', key: "Q3YANWUYUANYIN", tooltip: true, isSelect: true, minWidth: 150},
  ...
  {props:'bmgDelay',name:'BMG是否延误', key: "BMGSHIFOUYANWU", tooltip: true, isSelect: true, minWidth: 150},
  {props:'bmgReason',name:'BMG延误原因', key: "BMGYANWUYUANYIN", tooltip: true, isSelect: true, minWidth: 150},
  {props:'kickoffIst',name:'零件Kickoff时间', key: "LINGJIANKICKOFFSHIJIAN", tooltip: true, isSelect: true, minWidth: 150},
