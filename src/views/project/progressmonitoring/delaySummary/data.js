 ...
 * @LastEditTime: 2021-09-27 10:58:43
 * @Description: 
...
export const tableTitle = [
  ...
  {props:'scheNomiTimeKw',name:'零件状态', key: "LINGJIANZHUANGTAI", tooltip: true, minWidth: 120},
  {props:'scheKickoffTimeKw',name:'原计划时间', key: "YUANJIHUASHIJIAN", tooltip: true, minWidth: 120},
  {props:'scheFirstTryoutTimeKw',name:'已延误周数', key: "YIYANWUZHOUSHU", tooltip: true, minWidth: 140},
  {props:'delayReason',name:'延误原因', key: "YANWUYUANYIN", tooltip: true, minWidth: 120},
  {props:'newPlanKw',name:'新计划时间', key: "XINJIAHUASHIJIAN", tooltip: true, minWidth: 120},
  {props:'fs',name:'询价采购员', key: "XUNJIACAIGOUYUAN", tooltip: true, minWidth: 120},
  {props:'delayWeek',name:'Linie', key: "LINIE", tooltip: true, minWidth: 120},
  ...
  {props:'delayWeek',name:'实际回复日期', key: "SHIJIHUIFURIQI", tooltip: true, minWidth: 120},
]
...
export const searchList = [
  ...
  {value: 'confirmStatus', name: '回复状态', key: 'HUIFUZHUANGTAI', type: 'selectDict', selectOption: 'PART_SCHEDULE_CONFIRM_STATUS'},
