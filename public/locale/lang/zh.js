(function(global, factory) {
    ...
    i18n.setLocaleMessage('zh', {
        ...
        'rfq': {
            ...
            'RFQPARTNUMBERFSNRRFQBUYER': '零件号/FSNR/RFQ编号/询价采购员/Linie/供应商名称',
        ...
        */
        ...
        'LK_ZUZHIJIGOUBIANMA': '组织机构编码', //组织机构编码
        'LK_ZUZHIJIGOUMINGCHENG': '组织机构名称', //组织机构名称
        'LK_ZUZHIJIGOUJIANMA': '组织机构简码', //组织机构编码
        'LK_ZUZHIJIGOUJIANCHENG': '组织机构简称', //组织机构编码
        'LK_GANGWEIBIANMA': '岗位编码', //岗位编码
        'LK_GANGWEIQUANCHENG': '岗位全称', //岗位全称
        'LK_ZUZHILINGDAO': '组织领导', //组织领导
    })
}))