(function (global, factory) {
	...
	var oldLanguage = {
		...
		"零件进度报告":"Parts Progress Report",
		"材料成本报告":"Material Cost Report",
		"项目管理绩效分析":"Project management performance analysis",
		"以下报表统计维度为零件数量":"The following report statistics dimension is part quantity",
		"材料成本维护":"Material Cost Maintenance",
		PROCAIGOUXIANGMULEIXING: 'Proc. Proj. Type',
		"下载上传模板": 'Download Template',
		"批量上传": 'Upload',
		"编辑表头":"Edit Header",
		"PROJECTVSI参考零件号":"VSI Reference Part No",
		"PROJECTVSI参考零件名称":"VSI Reference Part Name",
		"PROJECTVWSet":"VW Set",
		"PROJECTVSI参考模块":"VSI Reference Module",
		"PROJECTVSI单价":"VSI-Unit Price",
		"PROJECTVSI数量":"VSI-Quantity",
		"PROJECTVSI整车":"VSI-Complete Vehicle",
		"PROJECT定点零件号":"Fixed point Part No",
		"PROJECT定点A价":"Fixed point A price",
		"PROJECT定点整车":"Fixed point-Complete Vehicle",
		"PROJECT定点供应商":"Designated suppliers",
		"PROJECT科室":"Dep",
		"PROJECTFS号":"FS Number",
		"PROJECT采购项目类型":"Purchase Item Type",
		"PROJECT年降":"Annual drop",
		"PROJECT年降SOP1":"Annual drop(SOP+1)",
		"PROJECT年降SOP2":"Annual drop(SOP+2)",
		"PROJECT年降SOP3":"Annual drop(SOP+3)",
		"PROJECT模具预算":"Mold budget",
		"PROJECT定点模具费用":"Fixed mold cost",
		"请勾选需导出的报表":"Please check the report to be exported",
		"请选择需要刷新的车型项目":"Please select the model item to refresh",
		"是否确认删除选中的记录":"Are you sure to delete the selected record",
		"定点零件清单":"Fixed point parts list",
		"格式校验错误":"Format verification error",
		"rulesError错误信息":"error message",
		"rulesError零件号":"Part No",
		"rulesError零件名称":"Part Name",
		"rulesErrorVWSet":"VW Set",
		"rulesError参考模块":"VSI Reference module",
		"rulesError单价":"VSI Unit Price",
		"rulesError数量":"VSI Quantity",
		"明细数据":"Detail Data",
		"EM准时完成率":"EM on-time completion rate",
		"EM总数":"EM Total",
		"EM完成数量":"EM Completed Quantity",
		"请选择需要删除的数据":"Please select the data to be deleted?",
		"请输入VSI参考零件号":"Please enter the VSI reference part number",
		"请输入或选择参考零件号":"Please enter or select reference part number",
		"请先编辑保存VSI数据":"Please edit and save VSI data first",
		"供应商EM准时完成情况报告":"Supplier EM on-time completion report",
		"供应商OTS准时完成情况报告":"Supplier OTS on-time completion report",
		...
		"延误状态":"Delay status",
		"零件总个数":"Total number of parts",
		"当前定点完成数量":"Current fixed point completion quantity",
		"当前已完成送样数量":"Current completed sample delivery quantity",
		"总览":"Overview",
		"延误清单":"Delay list",
    	"送样过程监控":"Sample sending process monitoring",
		"进度状态":"Progress status",
		"列表":"List",
		"进度":"Progress",
		"延迟原因备注":"Delay Reason Remarks",
		"零件所属供应商":"Suppliers of parts",
		"零件编号/零件名称":"part Num/part Name",
		"延迟级别":"Delay Level",
		"延迟原因":"Delay Reason",
		"完成状况":"Completion status",
		"延迟图":"Delay graph",
		"offen图":"offen graph",
		"延迟级别汇总":"Delay Level Summary",
		"延迟原因汇总":"Summary of delay reasons",
		"Offen类型汇总":"Offen Type Summary",
		"零件清单列表":"Parts list",
		"HeavyItem零件":"HeavyItem Parts",
		"普通零件":"Common parts",
		"heavyItem零件设置":"HeavyItem part settings",
		"发送供应商填写计划":"Send Supplier Plan",
		"备选清单":"Alternative list",
		"查询条件":"query criteria",
		"材料组/材料名称/零件编号/零件名称":"Material group/material name/part number/part name",
		"送样零件":"Sample parts",
		"任务发送时间":"Task send time",
		"批量发送":"Batch send",
		"节点":"node",
		"计划":"Plan",
		"预计开始":"Expected start",
